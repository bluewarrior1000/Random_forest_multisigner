...
forest.treedepth = 3; %maximum depth to grow each tree
forest.numfeatures = 2; %number of features used for testing
forest.numclasses = 5; %number of classes in decision tree classifiation

%setup an empty forest 
for t = 1:forest.numtrees
    for d = 1:(forest.treedepth)

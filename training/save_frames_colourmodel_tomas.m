...
save(sprintf('./frames/colourmodel_tomas_larger/video%d/images.mat',opts.video_num),'images');
save(sprintf('./frames/colourmodel_tomas_larger/video%d/trainingset.mat',opts.video_num),'opts');

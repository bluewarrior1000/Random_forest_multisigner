function mcc_wrapper_1signer_test_trees(sarg)
    ...
    save(sprintf('%svideo%d/pred_joints_width_%d_depth_%d_numtrees_%d.mat',...
       opts.results_dir,opts.video_num,opts.windowwidth, opts.forest.maxdepth,opts.forest.numtrees),'pred_joints','accuracy','dist_frm_GT');

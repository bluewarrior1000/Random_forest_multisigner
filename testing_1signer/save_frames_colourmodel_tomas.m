...
images = repmat(uint8(0),[opts.stdimgheight, opts.stdimgwidth, 3, length(opts.testingset)]);
...
save(sprintf('./frames/colourmodel_tomas/video%d/images.mat',opts.video_num),'-v7.3','images');
save(sprintf('./frames/colourmodel_tomas/video%d/testingset.mat',opts.video_num),'opts');
